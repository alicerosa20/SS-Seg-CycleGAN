...
class DataGenerator(keras.utils.all_utils.Sequence):
    ...
    def __init__(self, partition, batch_size, img_size=(256,256,64,3), mask_size=(256,256,64,2), shuffle=True):
        ...
        self.list_IDs = sorted(os.listdir('./Dataset_3/Patches_64/'+ partition +'/Images/'), key=self.order_dirs)
    ...
    def __get_data(self, list_IDs_temp):
        ...
        for i, ID_path in enumerate(list_IDs_temp):
            ...
            X[i,] = imread('./Dataset_3/Patches_64/'+ self.partition + '/Images/' + ID_path)

            mask[i,] = imread('./Dataset_3/Patches_64/'+ self.partition + '/Masks/'+ ID_path)
